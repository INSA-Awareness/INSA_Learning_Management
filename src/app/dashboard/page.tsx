        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="bg-white border-b border-gray-200 px-6 lg:px-12 py-3 flex items-center justify-between sticky top-16 z-40 shadow-sm">
                <div className="flex gap-6 text-sm font-semibold">
                    <Link href="/dashboard" className="text-brand-red border-b-2 border-brand-red pb-3 -mb-3">Dashboard</Link>
                ...
                <div className="flex items-center gap-6">
                    <div className="relative hidden md:block">
                        ...
                        <input
                            ...
                            className="pl-9 pr-4 py-1.5 bg-gray-100 border-none rounded-full text-sm w-64 focus:ring-1 focus:ring-brand-red focus:bg-white transition-all outline-none"
                        />
                    </div>
                    <div className="flex items-center gap-3 border-l border-gray-200 pl-6">
                        <div className="text-right hidden sm:block">
                            <div className="text-sm font-bold text-gray-900 leading-tight">Alex Morgan</div>
                            <div className="text-xs text-gray-500">Local IT Specialist</div>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-brand-dark flex items-center justify-center text-white font-bold shrink-0 shadow-sm overflow-hidden">
                            <img src="https://ui-avatars.com/api/?name=Alex+Morgan&background=1e1e24&color=fff" alt="User Avatar" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 mt-10">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-brand-red mb-1">Welcome back, Alex.</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-md hover:border-brand-red/30 transition-all group flex gap-4 cursor-pointer relative overflow-hidden">
                                ...
                                <div className="flex-1">
                                    <h4 className="font-bold text-gray-900 group-hover:text-brand-red transition-colors">Advanced Password Security</h4>
                                    <p className="text-xs text-gray-500 mb-2">Module 3 of 5 • Estimated 15 mins left</p>
                                    <div className="w-full bg-gray-100 rounded-full h-1.5 mb-1 overflow-hidden">
                                        <div className="bg-brand-red h-1.5 rounded-full w-[60%] group-hover:bg-red-600 transition-colors"></div>
                                    </div>
                                    <div className="flex justify-between text-[10px] font-bold text-gray-400 mt-2">
                                        <span>60% COMPLETED</span>
                                        <span className="text-brand-red group-hover:underline cursor-pointer">RESUME &rarr;</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-lg font-bold text-brand-red">Recommended Training</h2>
                                <Link href="/training" className="text-xs font-semibold text-gray-500 hover:text-brand-red flex items-center gap-1">View catalog &rarr;</Link>
                            </div>

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col hover:border-brand-red/30 transition-colors">
                                    <div className="h-32 bg-brand-dark relative overflow-hidden border-b border-gray-800 flex items-center justify-center">
                                    ...
                                    <div className="p-5 flex flex-col flex-1">
                                        ...
                                        <button className="w-full bg-brand-red text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-brand-red-hover transition-colors shadow-sm">
                                            Start Module &rarr;
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        {/* Quick Actions */}
                        <div>
                            <h2 className="text-sm font-bold text-brand-red tracking-wider uppercase mb-4">Quick Actions</h2>
                            <div className="space-y-3">
                                <div className="bg-white border text-left border-gray-100 p-4 rounded-xl flex items-center gap-4 hover:border-brand-red/30 hover:shadow-sm cursor-pointer transition-all group">
                                    <div className="w-10 h-10 rounded-full bg-red-50 text-brand-red flex items-center justify-center group-hover:bg-brand-red group-hover:text-white transition-colors shrink-0">
                                        &#9888;
                                    </div>
                                    <div className="flex-1">
                                    ...
                                    <div className="text-gray-300 group-hover:text-brand-red">&#11162;</div>
                                </div>
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-sm font-bold text-brand-red tracking-wider uppercase">Latest Intelligence</h2>
                                ...
                                <div className="space-y-4">
                                    <div className="border-b border-gray-100 pb-4">
                                        <div className="flex justify-between text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">
                                            <span className="text-brand-red">Active Campaign</span>
                                            <span>2 hrs ago</span>
                                        </div>
                                        <p className="text-sm font-medium text-gray-900 hover:text-brand-red cursor-pointer leading-tight transition-colors">
