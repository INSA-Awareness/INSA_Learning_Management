                        ...
                        <div className="space-y-4">
                            ...
                            {q.type === 'matching' && (
                                <div className="space-y-3">
                                    ...
                                    {Object.entries(q.correct_answer as Record<string, string>).map(([term, def], i) => (
                                        <div key={i} className="flex gap-2">
                                            <input
                                                ...
                                                value={term}
                                                onChange={(e) => {
                                                    const newAnswers = { ...(q.correct_answer as Record<string, string>) };
                                                    delete newAnswers[term];
                                                    newAnswers[e.target.value] = def;
                                            ...
                                            <input
                                                ...
                                                value={def}
                                                onChange={(e) => {
                                                    const newAnswers = { ...(q.correct_answer as Record<string, string>), [term]: e.target.value };
                                                    updateQuestion(q.id, { correct_answer: newAnswers });
                                                }}
                                            />
                                            <button
